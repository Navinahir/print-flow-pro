    ...
    >
        <form method="POST" action="{{ route('uploads.store') }}" enctype="multipart/form-data" class="space-y-6" x-on:submit="submitting = true">
            ...
            <div class="merchant-card">
                ...
                <p class="mt-2 text-xs text-slate-500" x-show="type === 'order_pdf' || type === 'thermal_label' || type === 'delivery_label'">
            ...
            >
                ...
                <label for="merchant-upload-files" class="cursor-pointer">
                    ...
                    <p class="mt-4 text-sm font-medium text-slate-700">
                        ...
                        <span class="text-amber-700">{{ __('merchant.uploads.form.dropzone_browse') }}</span>
                    </p>
